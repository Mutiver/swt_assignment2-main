...
namespace Ladeskab
{
    public class USBCharger : IUSBCharger
    {
        ...
        public event EventHandler<USBChargeChangedEventArgs>? USBChargeChanged;
        ...
        {
            USBChargeChanged?.Invoke(this, new USBChargeChangedEventArgs() { Current = this.CurrentValue });
        }
    }
}
